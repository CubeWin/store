...
const genProducto = async(familiaArr, impuestoId)=>{
    ...
    const PRODUCTO = [
        {fam_id:familiaArr.filter(c=> c.codigo == '001001001'?? c._id)[0]._id, marca:"Samsung", color:"negro", unidad:"pulgadas", valor:"21", modelo:"SNMLD21", precio:"220", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001001'?? c._id)[0]._id, marca:"Samsung", color:"negro", unidad:"pulgadas", valor:"32", modelo:"SNMLD32", precio:"360", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001002'?? c._id)[0]._id, marca:"Samsung", color:"negro", unidad:"pulgadas", valor:"32", modelo:"SNMPLS32", precio:"310", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001002'?? c._id)[0]._id, marca:"LG", color:"negro", unidad:"pulgadas", valor:"32", modelo:"LGPLS32", precio:"330", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001003'?? c._id)[0]._id, marca:"AOC", color:"negro", unidad:"pulgadas", valor:"32", modelo:"AOC32", precio:"330", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001004'?? c._id)[0]._id, marca:"LG", color:"negro", unidad:"pulgadas", valor:"49", modelo:"LGOLP49", precio:"1600", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001004'?? c._id)[0]._id, marca:"LG", color:"negro", unidad:"pulgadas", valor:"55", modelo:"LGOLP55", precio:"2500", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001004'?? c._id)[0]._id, marca:"LG", color:"negro", unidad:"pulgadas", valor:"65", modelo:"LGOLP65", precio:"3500", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001004'?? c._id)[0]._id, marca:"Samsung", color:"negro", unidad:"pulgadas", valor:"65", modelo:"SMNOLP65", precio:"3400", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001001004'?? c._id)[0]._id, marca:"Samsung", color:"negro", unidad:"pulgadas", valor:"55", modelo:"SMNOLP55", precio:"2100", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001002001'?? c._id)[0]._id, marca:"Samsung", color:"azul", unidad:"año", valor:"2020", modelo:"Samsung j7", precio:"600", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001002001'?? c._id)[0]._id, marca:"Samsung", color:"blanco", unidad:"año", valor:"2022", modelo:"Samsung galaxi S22", precio:"2800", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001002002'?? c._id)[0]._id, marca:"ZTE", color:"blanco", unidad:"año", valor:"2021", modelo:"ZTE", precio:"70", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '001002002'?? c._id)[0]._id, marca:"ZTE", color:"blanco", unidad:"año", valor:"2022", modelo:"ZTE", precio:"90", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '002001003'?? c._id)[0]._id, marca:"BOSCH", color:"negro", unidad:"hornillas", valor:"4", modelo:"PKF675FP1E", precio:"1400", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '002001004'?? c._id)[0]._id, marca:"Nationalizer", color:"negro", unidad:"hornillas", valor:"1", modelo:"2167", precio:"199", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '002002001'?? c._id)[0]._id, marca:"LG", color:"blanco", unidad:"litros", valor:"374", modelo:"GT39SGP", precio:"2699", imp_id: impuestoId},
        {fam_id:familiaArr.filter(c=> c.codigo == '002002001'?? c._id)[0]._id, marca:"Mabe", color:"negro", unidad:"litros", valor:"300", modelo:"RMA310FZPC", precio:"1899", imp_id: impuestoId},
    ]
